...
export class LocationService {
  ...
  public async getCityAutocomplete(cityName: string) {
    const optionalCities = await this.http.get<any>(`https://dataservice.accuweather.com/locations/v1/cities/autocomplete?apikey=0UCIQbymKHASO6CCAmFCmdx0EnWufncK&q=${cityName}`)
